...
def run(args: argparse.Namespace) -> None:
    ...
    # openEquivariance:
    if args.enable_oeq:
        logging.info("Converting model to OpenEquivariance for accelerated training")
        assert model.__class__.__name__ in ["MACE", "ScaleShiftMACE"] # Just the same as CUEQ
